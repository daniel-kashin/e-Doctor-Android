package com.danielkashin.edoctor.data.local.event

import com.danielkashin.edoctor.data.entity.local.event.MedicalEventEntity
import com.danielkashin.edoctor.data.entity.local.event.MedicalEventEntityContract
import com.danielkashin.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_DOCTOR_CREATOR_UUID
import com.danielkashin.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_IS_ADDED_FROM_DOCTOR
import com.danielkashin.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_IS_CHANGED_LOCALLY
import com.danielkashin.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_IS_DELETED
import com.danielkashin.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_PATIENT_UUID
