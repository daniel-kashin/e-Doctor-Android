package com.infostrategic.edoctor.data.local.message

import com.infostrategic.edoctor.data.entity.local.message.MessageEntity
import com.infostrategic.edoctor.data.entity.local.message.MessageEntityContract
import com.infostrategic.edoctor.data.local.base.BaseLocalStore
import com.infostrategic.edoctor.data.entity.local.message.MessageEntityContract.COLUMN_RECIPIENT_UUID
import com.infostrategic.edoctor.data.entity.local.message.MessageEntityContract.COLUMN_SENDER_UUID
import com.infostrategic.edoctor.data.entity.local.message.MessageEntityContract.COLUMN_TIMESTAMP
