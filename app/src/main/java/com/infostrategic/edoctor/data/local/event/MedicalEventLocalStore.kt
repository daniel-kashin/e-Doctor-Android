package com.infostrategic.edoctor.data.local.event

import com.infostrategic.edoctor.data.entity.local.event.MedicalEventEntity
import com.infostrategic.edoctor.data.entity.local.event.MedicalEventEntityContract
import com.infostrategic.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_DOCTOR_CREATOR_UUID
import com.infostrategic.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_IS_ADDED_FROM_DOCTOR
import com.infostrategic.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_IS_CHANGED_LOCALLY
import com.infostrategic.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_IS_DELETED
import com.infostrategic.edoctor.data.entity.local.event.MedicalEventEntityContract.COLUMN_PATIENT_UUID
