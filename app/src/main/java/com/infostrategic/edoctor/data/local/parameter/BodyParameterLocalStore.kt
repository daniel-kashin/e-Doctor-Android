package com.infostrategic.edoctor.data.local.parameter

import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntity
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.COLUMN_TYPE
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.TABLE_NAME
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.COLUMN_UUID
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.COLUMN_CUSTOM_MODEL_UNIT
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.COLUMN_CUSTOM_MODEL_NAME
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.COLUMN_IS_CHANGED_LOCALLY
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.COLUMN_IS_DELETED
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityContract.COLUMN_PATIENT_UUID
import com.infostrategic.edoctor.data.entity.local.parameter.BodyParameterEntityType
import com.infostrategic.edoctor.data.local.base.BaseLocalStore
